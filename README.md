...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 226 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 226 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 226 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 226 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 226 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 226 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 226 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 226 新增上下样张 4"></td>
  </tr>
</table>

## 适用场景与解决的问题

适合想把日常照片做成温暖收藏小品的场合：个人摄影整理、独立出版、展览练习、生活方式品牌。上半保留可辨认的原照；下半不是给照片套饼干滤镜，而是先读懂含义与关系，再用糖霜、翻糖和软陶把主体连同必要环境做成一枚浅浮雕曲奇。

整体呈现简洁、完整、诗意、温暖、具有收藏感：小尺度章印、大面积留白、明亮柔和的霜彩色。避免逐物复刻、背景填满、塑料高光、廉价卡通和模板化图标。
...
安装后重新启动 Agent 会话，然后调用 `$xxd-panel-226`。也可以按需追加 `--global --agent codex --yes` 做用户级安装。

常用调用示例：

```text
/xxd-panel-226 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale zh-CN
...
完整运行契约见 [SKILL.md](SKILL.md)；运行适配器见 [英文](references/xxd-panel-226-prompt.en.md) 与 [中文](references/xxd-panel-226-prompt.zh-CN.md)。
...
- `design-only`：整张画布只呈现 Panel 226 的设计转译，照片只作为不可见参考。
